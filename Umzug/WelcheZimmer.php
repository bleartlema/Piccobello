...
<div class="jumbotron">
    ...
    <div align="center">
        <div class="col-sm-10">
            <h1>Welche Möbel & Gegenstände zügeln Sie?</h1>
            <h5>Geben Sie Ihre Möbel & grossen Gegenstände an, welche nicht in Umzugskartons passen.</h5>
            ...
            <button type="button" class="btn btn-primary btn-lg gross" data-toggle="modal" data-target="#exampleModal">
                Zimmer hinzufügen
            </button>
        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Zimmer hinzufügen</h5>
                    ...
                    <div class="modal-body">
                        <button type="submit" class="btn zimmerhinzufuegen"><i class="material-icons"></i> Wohnzimmer</button>
                    </div>

                    <!---->
                    <div class="modal-body">
                        <button type="submit" class="btn zimmerhinzufuegen"><i class="fa fa-bed"></i> Schlafzimmer</button>
                    </div>

                    <!---->
                    <div class="modal-body">
                        <button type="submit" class="btn zimmerhinzufuegen"><i class="fa  fa-coffee"></i> Küche</button>
                    </div>

                    <!---->
                    <div class="modal-body">
                        <button type="submit" class="btn zimmerhinzufuegen"><i class="fa fa-s15"></i> Bad & Gang</button>
                    </div>


                    <!---->
                    <div class="modal-body">
                        <button type="submit" class="btn zimmerhinzufuegen"><i class="fa fa-bed"></i> Büro</button>
                    </div>

                    <!---->
                    <div class="modal-body gross">
                        <button type="submit" class="btn zimmerhinzufuegen"><i class="fa fa-bed"></i> Dachboden</button>
                    </div>

                    <!---->
                    <div class="modal-body">
                        <button type="submit" class="btn zimmerhinzufuegen"><i class="fa fa-suitcase"></i> Keller</button>
                    </div>

                    <!---->
                    <div class="modal-body">
                        <button type="submit" class="btn zimmerhinzufuegen"><i  class="fa fa-car"></i> Garge</button>
                    </div>
    ...
    <div align="center">
        <div class="col-sm-10">
            ...
            <div class="btn-group mr-2" role="group" aria-label="Second group">
                <form action="WoZiehenSieEin.html">
