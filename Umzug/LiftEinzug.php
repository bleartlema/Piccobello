    ...
    <div class="jumbotron">
        ...
        <div class="progress">
            <div class="progress-bar progress-bar-success progress-bar-striped" role="progressbar"
                 aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width:72%">
                72%
            </div>
        </div>
        ...
        <div align="center">
            <div class="col-sm-10">
                ...
                <button type="submit" id="keinLift" name="keinLift" class="btn btn-primary btn-lg gross">Nein
                </button>
            ...
            <div class="col-sm-10">
                <!--Umzugsreinigung Button-->
                <button type="submit" id="lift6+Pers" name="lift6+Pers" class="btn btn-primary btn-lg gross">Ja, für
                    6+ Personen
                </button>
            </div>
            <br>
