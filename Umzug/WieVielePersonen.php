...
<div class="jumbotron">
    ...
    <div align="center">
        <div class="container mt-5">
            <h1>Wie viele Personen ziehen um & wie viele Umzugskartons benötigen Sie?</h1>
            <br>
            <div class="row">
                ...
                <div class="col-sm-4 col-sm-offset-4">
                    <div class="col-sm-10">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="number" id="Anz_Personen" class="form-control form-control-sm" value="0" min="1"
                                   max="1">
                            <div class="input-group-prepend">
        ...
        <script>
            ...
            $(document).ready(function () {
                $('#Anz_Personen').prop('disable', true);
            ...
            <div class="row">
                ...
                <div class="col-sm-4 col-sm-offset-4">
                    <div class="col-sm-10">
                        ...
                        <div class="btn-group mr-2" role="group" aria-label="Second group">
                            <form action="Informationen.html">
