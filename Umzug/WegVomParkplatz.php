...
<div class="jumbotron">
    ...
    <!--        <a class="navbar-brand" href="/Piccobello/start.php">Start</a>-->
    ...
    <div class="progress">
        <div class="progress-bar progress-bar-success progress-bar-striped" role="progressbar"
             aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width:42%">
            42%
        </div>
    </div>
    ...
    <div align="center">
                ...
                <div class="col-sm-4 col-sm-offset-4">
                    <div class="col-sm-10">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="number" id="Weg_Meter" class="form-control form-control-sm" value="10" min="10"
                                   max="200">
                            <div class="input-group-prepend">
        ...
        <script>
            ...
            $(document).ready(function () {
                $('#Weg_Meter').prop('enable', true);

                $('#plus-btn1').click(function () {
                    $('#Weg_Meter').val(parseInt($('#Weg_Meter').val()) + 10);

                    //Nicht mehr wie 8
                    if ($('#Weg_Meter').val() >= 200) {
                        $('#Weg_Meter').val(200);
                    }
                ...
                <div class="col-sm-4 col-sm-offset-4">
                    <div class="col-sm-10">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="number" id="Anz_Stufen" class="form-control form-control-sm" value="0" min="10"
                                   max="5000">
                            <div class="input-group-prepend">
                        ...
                        <div class="btn-group mr-2" role="group" aria-label="Second group">
                            <form action="WieGross.html">
                                <button type="submit" class="btn btn-primary">Zurück</button>
                            </form>
                        </div>

                        <div class="btn-group mr-2" role="group" aria-label="Second group">
                            <form action="ZusaetzlicheOptionen.html">
