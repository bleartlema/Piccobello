    ...
    <div class="jumbotron">
        ...
        <div align="center">
            ...
            <div class="col-sm-10">
                ...
                <button type="submit" id="keinLift" name="keinLift" class="btn btn-primary btn-lg gross">Nein</button>

            </div>
            <br>
            <div class="col-sm-10">
                <!--Umzug Buutton-->
                <button type="submit" id="lift2bis3Pers" name="lift2bis3Pers" class="btn btn-primary btn-lg gross">Ja,
                    für 2-3 Personen
                </button>
            </div>
            <br>
            ...
            <div class="col-sm-10">
                ...
                <button type="submit" id="lift4bis5Pers" name="lift4bis5Pers" class="btn btn-primary btn-lg gross">Ja,
                    für 4-5 Personen
                </button>
            </div>
            <br>
            <div class="col-sm-10">
                <!--Umzugsreinigung Button-->
                <button type="submit" id="lift6+Pers" name="lift6+Pers" class="btn btn-primary btn-lg gross">Ja, für 6+
                    Personen
                </button>
            </div>
            <br>
            ...
            <div class="col-sm-10">
                <!--Umzugsreinigung Button-->
                <button type="submit" id="lift10+Pers" name="lift10+Pers" class="btn btn-primary btn-lg gross">Ja,
                    Warenlift für 10+ Personen
                </button>
            </div>
        </div>
    </div>
