...
<div class="jumbotron">
    ...
    <!--&lt;!&ndash;        <a class="navbar-brand" href="/Piccobello/start.html">Start</a>&ndash;&gt;-->

    <!--&lt;!&ndash;        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav"&ndash;&gt;-->
    <!--&lt;!&ndash;                aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">&ndash;&gt;-->
    ...
    <div class="container mt-5">
        <h1 align="center">Wie gross ist Ihr Haus?</h1>
        <br>
        <div class="row">
            ...
            <div class="col-sm-4 col-sm-offset-4">
                <div class="col-sm-10">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" id="Anz_Zimmer" class="form-control form-control-sm" value="0" min="1"
                               max="1">
                        <div class="input-group-prepend">
            ...
            <div class="col-sm-4 col-sm-offset-4">
                <div class="col-sm-10">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" id="qty_input0" class="form-control form-control-sm" value="0" min="10"
                               max="5000">
                        <div class="input-group-prepend">
                    ...
                    <div class="btn-group mr-2" role="group" aria-label="Second group">
                        <form action="WegVomParkplatzEinzug.html">
...
<script>
    $(document).ready(function () {
        $('#Anz_Zimmer').prop('enable', true);

        $('#plus-btn1').click(function () {
            $('#Anz_Zimmer').val(parseInt($('#Anz_Zimmer').val()) + 1);
    ...
    $(document).ready(function () {
        $('#qty_input0').prop('enable', true);

        $('#plus-btn0').click(function () {
            $('#qty_input0').val(parseInt($('#qty_input0').val()) + 10);
            if ($('#qty_input0').val() >= 300) {
                $('#qty_input0').val(300);
            }
