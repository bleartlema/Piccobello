...
<form>
    ...
    <div class="jumbotron">
        ...
        <div align="center">
            <div class="col-sm-10">
                <h1 align="center">Wo Ziehen Sie aus?</h1>

                <br>

                <!--Umzug&Reinigung Button---------------------------------------------------------------------------------------------------------------->
                <button type="submit" id="btn_Haus_ausziehen" formaction="/Piccobello/UmzugUndReinigung/WieGross.php" class="btn btn-primary btn-lg gross">
                    Haus
                </button>
                <!--Umzug&Reinigung Button Ende------------------------------------------------------------------------------------------------------------>
            </div>
            ...
            <div class="col-sm-10">
                <!--Wohnung Buutton-------------------------------------------------------------------------------------------------------------------------------->
                <button type="submit" id="btn_Wohnung_ausziehen" formaction="/Piccobello/UmzugUndReinigung/AufWelchemStock.php" class="btn btn-primary btn-lg gross">
                    Wohnung
                </button>
                <!--Wohnung Buutton Ende--------------------------------------------------------------------------------------------------------------------------->
            </div>
            ...
            <div class="col-sm-10">
                <!--WG-Zimmmer Button------------------------------------------------------------------------------------------------------------------------------------------->
                <button type="submit" action="" id="btn_WG-Zimmer_ausziehen" formaction="/Piccobello/UmzugUndReinigung/AufWelchemStock.php" class="btn btn-primary btn-lg gross">
                    WG-Zimmer
                </button>
                <!--WG-Zimmmer Button Ende--------------------------------------------------------------------------------------------------------------------------------------->
            </div>

            <br>

            <div class="col-sm-10">
                <form action="AufWelchemStock.php">
                    <!--Lager Button-------------------------------------------------------------------------------------------------------------------------------------------->
                    <button type="submit" action="" id="btn_Lager_ausziehen" formaction="/Piccobello/UmzugUndReinigung/AufWelchemStock.php" class="btn btn-primary btn-lg gross">
                        Lager
                    </button>
                    <!--Lager Button Ende---------------------------------------------------------------------------------------------------------------------------------------->
                </form>
            ...
            <div class="col-sm-10">
                <!--Büro Button--------------------------------------------------------------------------------------------------------------------------------------------->
                <button type="submit" action="" id="btn_Buero_ausziehen" formaction="/Piccobello/UmzugUndReinigung/AufWelchemStock.php" class="btn btn-primary btn-lg gross">
                    Büro
                </button>
                <!--Büro Button Ende---------------------------------------------------------------------------------------------------------------------------------------->
            </div>
            ...
            <div class="col-sm-10">
                <div class="btn-group mr-2" role="group" aria-label="Second group">
                    <!--Zurück Button---------------------------------------------------------------------------------------------------------------------------------------->
                    <button type="submit" formaction="/Piccobello/UmzugUndReinigung/Formulare.php" class="btn btn-primary">
                        Zurück
                    </button>
                    <!--Zurück Button Ende---------------------------------------------------------------------------------------------------------------------------------------->
                </div>
