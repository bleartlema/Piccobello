                ...
                <div class="col-sm-10">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="input-group-prepend">
                            <button class="btn btn-dark btn-sm" id="minus-btn1_einziehen"><i class="fa fa-minus"></i></button>
                        </div>
                        <input type="number" id="Weg_Meter_einziehen" class="form-control form-control-sm" value="0"
                               min="0"
                               max="200">
                        <div class="input-group-prepend">
                            <button class="btn btn-dark  btn-sm" id="plus-btn1_einziehen"><i class="fa fa-plus"></i></button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-4 col-sm-offset-4">
                <div class="col-sm-10">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="input-group-prepend">
                            <button class="btn btn-dark btn-sm" id="minus-btn0_einziehen"><i class="fa fa-minus"></i></button>
                        </div>
                    ...
                    <div class="btn-group mr-2" role="group" aria-label="Second group">
                        <form action="WieGrossEinzug.php">
                            <button type="submit" class="btn btn-primary">Zurück</button>
                        </form>
                    </div>

                    <div class="btn-group mr-2" role="group" aria-label="Second group">
                        <form action="WieVielePersonen.php">
