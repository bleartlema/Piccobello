...
<div class="jumbotron">
    ...
    <div class="progress">
        <div class="progress-bar progress-bar-success progress-bar-striped" role="progressbar"
             aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width:55%">
            55%
        </div>
    </div>
    ...
    <div class="container mt-5">
        <h1 align="center">Welche Storen sollen gereinigt werden?</h1>
        <div class="container mt-5">
            <div class="row">
                ...
                <div class="col-sm-4 col-sm-offset-4">
                    <div class="col-sm-10">
                        ...
                        <div class="custom-control custom-checkbox">
                            ...
                            <input type="checkbox" class="custom-control-input" id="Lamellenstoren_checkb">
                            <label class="custom-control-label" for="Lamellenstoren_checkb"><h7>Lamellenstoren</h7></label>
                        </div>
                        ...
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="KellerAbteil_checkb"><h7>Fensterläden</h7></label>
                        </div>

                        <!--Dachboden Checkbox-->
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="Dachboden_checkb">
                            <label class="custom-control-label" for="Dachboden_checkb"><h7>Rollläden</h7></label>
                        </div>
                        <!--Garage Checkbox-->

                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="Garage_checkb">
                            <label class="custom-control-label" for="Garage_checkb"><h7>Nichts Davon</h7></label>
                        </div>
                        ...
                        <div class="btn-group mr-2" role="group" aria-label="Second group">
                            <form action="OptionaleServices.php">
