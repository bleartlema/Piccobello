                ...
                <div class="row">
                    <div class="col-sm">
                        ...
                        <div class="col-sm-10">
                            ...
                            <!--Umzug Buutton-->
                            <button type="submit" name="btn_Untergeschoss" id="btn_Untergeschoss"
                                    formaction="/Piccobello/UmzugUndReinigung/WieGrossEinzug.php"
                        ...
                        <div class="col-sm-10">
                            ...
                            <!--Umzug Buutton-->
                            <button type="submit" name="btn_Hochparterre" id="btn_Hochparterre"
                                    formaction="/Piccobello/UmzugUndReinigung/LiftEinzug.php"
                                    class="btn btn-primary btn-lg btn-block">
                                Hochparterre
                            </button>
                        ...
                        <div class="col-sm-10">
                            ...
                            <!--Umzug Buutton-->
                            <button type="submit" name="btn_ZweiterStock" id="btn_ZweiterStock"
                                    formaction="/Piccobello/UmzugUndReinigung/LiftEinzug.php"
                                    class="btn btn-primary btn-lg btn-block">
                                2.
                            </button>
                        ...
                        <div class="col-sm-10">
                            ...
                            <!--Umzug Buutton-->
                            <button type="submit" name="btn_VierterStock" id="btn_VierterStock"
                                    formaction="/Piccobello/UmzugUndReinigung/LiftEinzug.php"
                                    class="btn btn-primary btn-lg btn-block">
                                4.
                            </button>
                        ...
                        <div class="col-sm-10">
                            <div class="btn-group mr-2" role="group" aria-label="Second group">
                                ...
                                <!--Zurück Button-->
                                <button type="submit" formaction="/Piccobello/UmzugUndReinigung/WoZiehenSieEin.php"
                    ...
                    <div class="col-sm">
                        <div class="col-sm-10">
                            ...
                            <!--Umzug Buutton-->
                            <button type="submit" name="btn_Erdgeschoss" id="btn_Erdgeschoss"
                                    formaction="/Piccobello/UmzugUndReinigung/LiftEinzug.php"
                                    class="btn btn-primary btn-lg btn-block">
                                Erdgeschoss
                            </button>
                        ...
                        <div class="col-sm-10">
                            ...
                            <!--Umzug Buutton-->
                            <button type="submit" name="btn_ErsterStock" id="btn_ErsterStock"
                                    formaction="/Piccobello/UmzugUndReinigung/LiftEinzug.php"
                                    class="btn btn-primary btn-lg btn-block">
                                1.
                            </button>
                        ...
                        <div class="col-sm-10">
                            ...
                            <!--Umzug Buutton-->
                            <button type="submit" name="bn" formaction="/Piccobello/UmzugUndReinigung/LiftEinzug.php"
                                    class="btn btn-primary btn-lg btn-block">
                                3.
                            </button>
                        ...
                        <div class="col-sm-10">
                            ...
                            <!--Umzug Buutton-->
                            <button type="submit" formaction="/Piccobello/UmzugUndReinigung/LiftEinzug.php"
                                    class="btn btn-primary btn-lg btn-block">
                                5+.
                            </button>
