...
<div class="jumbotron">
    ...
    <div align="center">
        <div class="col-sm-10">
            <h1 align="center">Bitte wählen Sie eine der folgenden Optionen:</h1>
            <br>
            ...
            <form action="WoZiehenSieAus.php">
                ...
                <button type="submit" id="btn_Online_Formular" class="btn btn-primary btn-lg gross">Online-Formular
                    ausfüllen
                </button>
            </form>
            ...
            <div class="col-sm-10">
                ...
                <form action="">
                    ...
                    <button type="button" action="" id="btn_Hausbesuch" class="btn btn-primary btn-lg gross">Hausbesuch
                        vereinbaren
                    </button>
                </form>

                <br>
                <form action="WoService.php">
