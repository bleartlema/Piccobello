                ...
                <div class="row">
                    <div class="col-sm">
                        ...
                        <div class="col-sm-10">
                            ...
                            <!--Umzug Buutton-->
                            <button type="submit" formaction="/Piccobello/UmzugUndReinigung/WieGross.php"
                                    class="btn btn-primary btn-lg btn-block">Untergeschoss
                            </button>
                        ...
                        <div class="col-sm-10">
                            ...
                            <!--Umzug Buutton-->
                            <button type="submit" formaction="/Piccobello/UmzugUndReinigung/Lift.php"
                                    class="btn btn-primary btn-lg btn-block">Hochparterre
                            </button>
                        ...
                        <div class="col-sm-10">
                            <form action="">
                                <!--Umzug Buutton-->
                                <button type="submit" formaction="/Piccobello/UmzugUndReinigung/Lift.php"
                                        class="btn btn-primary btn-lg btn-block">2.
                                </button>
                            </form>
                        </div>
                        <br>
                        ...
                        <div class="col-sm-10">
                            <form action="">
                                <!--Umzug Buutton-->
                                <button type="submit" formaction="/Piccobello/UmzugUndReinigung/Lift.php"
                                        class="btn btn-primary btn-lg btn-block">4.
                                </button>
                            </form>
                        </div>
                        ...
                        <div class="col-sm-10">
                            <div class="btn-group mr-2" role="group" aria-label="Second group">
                                ...
                                <!--Zurück Button-->
                                <button type="submit" formaction="/Piccobello/UmzugUndReinigung/WoZiehenSieAus.php"
                                        class="btn btn-primary">Zurück
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="col-sm">
                        <div class="col-sm-10">
                            <form action="">
                                <!--Umzug Buutton-->
                                <button type="submit" formaction="/Piccobello/UmzugUndReinigung/Lift.php"
                                        class="btn btn-primary btn-lg btn-block">Erdgeschoss
                                </button>
                            </form>
                        </div>
                        <br>
                        ...
                        <div class="col-sm-10">
                            <form action="">
                                <!--Umzug Buutton-->
                                <button type="submit" formaction="/Piccobello/UmzugUndReinigung/Lift.php"
                                        class="btn btn-primary btn-lg btn-block">1.
                                </button>
                            </form>
                        </div>
                        ...
                        <div class="col-sm-10">
                            <form action="">
                                <!--Umzug Buutton-->
                                <button type="submit" formaction="/Piccobello/UmzugUndReinigung/Lift.php"
                                        class="btn btn-primary btn-lg btn-block">3.
                                </button>
                            </form>
                        </div>
                        ...
                        <div class="col-sm-10">
                            <form action="">
                                <!--Umzug Buutton-->
                                <button type="submit" formaction="/Piccobello/UmzugUndReinigung/Lift.php"
                                        class="btn btn-primary btn-lg btn-block">5+.
                                </button>
                            </form>
                        </div>
