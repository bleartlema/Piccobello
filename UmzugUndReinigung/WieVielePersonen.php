...
<div class="jumbotron">
    ...
    <div class="container mt-5">
        <h1 align="center">Wie viele Personen ziehen um & wie viele Umzugskartons benötigen Sie?</h1>
        <br>
        <div class="row">
            ...
            <div class="col-sm-4 col-sm-offset-4">
                <div class="col-sm-10">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" id="Anz_Personen" class="form-control form-control-sm" value="0" min="0"
                               max="8">
                        <div class="input-group-prepend">
            ...
            <div class="col-sm-4 col-sm-offset-4">
                <div class="col-sm-10">
                    ...
                    <div class="btn-group mr-2" role="group" aria-label="Second group">
                        <form action="WegVomParkplatzEinzug.php">
                            <button type="submit" class="btn btn-primary">Zurück</button>
                        </form>
                    </div>

                    <div class="btn-group mr-2" role="group" aria-label="Second group">
                        <form action="Informationen.php">
...
<script>
    ...
    $(document).ready(function () {
        $('#Anz_Personen').prop('enable', true);

        $('#plus-btn1').click(function () {
            $('#Anz_Personen').val(parseInt($('#Anz_Personen').val()) + 1);

            //Nicht mehr wie 8
            if ($('#Anz_Personen').val() >= 8) {
                $('#Anz_Personen').val(8);
            }
