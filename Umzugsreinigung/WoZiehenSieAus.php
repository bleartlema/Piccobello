    ...
    <div class="jumbotron">
        ...
        <div align="center">
            <div class="col-sm-10">
                ...
                <button type="submit" id="btn_Haus_ausziehen" formaction="/Piccobello/Umzugsreinigung/WieGross.php" class="btn btn-primary btn-lg gross">Haus</button>
            ...
            <div class="col-sm-10">
                ...
                <!--Wohnung Buutton-->
                <button type="submit" id="btn_Wohnung_ausziehen" formaction="/Piccobello/Umzugsreinigung/WieGross.php" class="btn btn-primary btn-lg gross">Wohnung</button>
            ...
            <div class="col-sm-10">
                ...
                <!--WG-Zimmmer Button-->
                <button type="submit" action="" id="btn_WG-Zimmer_ausziehen" formaction="/Piccobello/Umzugsreinigung/WieGross.php" class="btn btn-primary btn-lg gross">WG-Zimmer</button>
            ...
            <div class="col-sm-10">
                ...
                <form action="AufWelchemStock.php">
                    <!--Lager Button-->
                    <button type="submit" action="" id="btn_Lager_ausziehen" formaction="/Piccobello/Umzugsreinigung/WieGross.php" class="btn btn-primary btn-lg gross">Lager</button>
                </form>
            </div>
            ...
            <div class="col-sm-10">
                ...
                <!--Büro Button-->
                <button type="submit" action="" id="btn_Buero_ausziehen" formaction="/Piccobello/Umzugsreinigung/WieGross.php" class="btn btn-primary btn-lg gross">Büro</button>
            ...
            <div class="col-sm-10">
                <div class="btn-group mr-2" role="group" aria-label="Second group">
                    ...
                    <!--Zurück Button-->
                    <button type="submit" formaction="/Piccobello/Umzugsreinigung/WoService.php" class="btn btn-primary">Zurück</button>
